...
const millsUrl = "https://opendata.arcgis.com/datasets/5c026d553ff049a585b90c3b1d53d4f5_34.geojson?where=country%20%3D%20'Indonesia'";

class ApiClient {

    static async getMills(){
        let jsonBody = await ApiClient.get(millsUrl);
        let millDict = {};
        jsonBody["features"].forEach(function(mill){
            millDict[mill["properties"]["objectid"]] = mill;
        });
        return millDict;
    }
